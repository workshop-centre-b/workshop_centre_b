 ...
 */
final class Version20240424072400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE menu ADD entree_id INT NOT NULL, ADD plat_un_id INT NOT NULL, ADD plat_deux_id INT NOT NULL, ADD plat_trois_id INT DEFAULT NULL, ADD dessert_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE menu_plat (menu_id INT NOT NULL, plat_id INT NOT NULL, INDEX IDX_E8775249CCD7E912 (menu_id), INDEX IDX_E8775249D73DB560 (plat_id), PRIMARY KEY(menu_id, plat_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE menu DROP entree_id, DROP plat_un_id, DROP plat_deux_id, DROP plat_trois_id, DROP dessert_id');
    }
}
