 ...
 */
final class Version20240424074410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE menu (id INT AUTO_INCREMENT NOT NULL, entree_id INT NOT NULL, plat_un_id INT NOT NULL, plat_deux_id INT NOT NULL, plat_trois_id INT DEFAULT NULL, dessert_id INT NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', service VARCHAR(255) NOT NULL, option_plat VARCHAR(255) NOT NULL, INDEX IDX_7D053A93AF7BD910 (entree_id), INDEX IDX_7D053A9325E182CC (plat_un_id), INDEX IDX_7D053A933B445268 (plat_deux_id), INDEX IDX_7D053A93852C1CB9 (plat_trois_id), INDEX IDX_7D053A93745B52FD (dessert_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
